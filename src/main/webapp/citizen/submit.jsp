...
<head>
    ...
    <title>Submit Grievance | Setu | Citizen Grievance Redressal Portal</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@600;700;800&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/submit.css">
        ...
        <div class="container mx-auto px-6 py-3">
            <nav class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button id="logout-btn" class="px-4 py-2 text-sm font-medium text-primary-blue bg-blue-100 rounded-lg hover:bg-blue-200 transition">
                        Logout
                    </button>
...
<div id="location-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-2xl p-6 max-w-sm mx-4">
        ...
        <h3 class="font-heading font-bold text-lg text-center text-gray-900 mb-2">Location Access</h3>
        <p class="text-gray-600 text-sm text-center mb-6">We use your location to tag your grievance for better resolution. Your location data is stored securely and is only used for this purpose.</p>
        <div class="flex space-x-4">
            <button id="location-deny" class="flex-1 px-4 py-2 bg-gray-200 text-gray-800 font-medium rounded-lg hover:bg-gray-300 transition">Deny</button>
            <button id="location-allow" class="flex-1 px-4 py-2 bg-primary-blue text-white font-medium rounded-lg hover:bg-blue-800 transition">Allow</button>
        </div>
    </div>
</div>
    <!-- Main Content -->
    <div class="flex">
        ...
        <div class="sidebar w-64 bg-white min-h-screen shadow-lg fixed md:relative z-40 md:z-auto">
            ...
            <nav class="mt-6">
                ...
                <a href="submit.jsp" class="flex items-center px-6 py-3 text-primary-blue bg-blue-50 border-r-4 border-primary-blue">
        ...
        <div class="flex-1 p-6 md:p-8">
            ...
            <div class="bg-gradient-to-r from-primary-blue to-blue-700 rounded-2xl p-6 text-white mb-8 card-glow">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                        <h1 class="font-heading text-2xl md:text-3xl font-bold mb-2">Submit a New Grievance</h1>
                        <p class="text-blue-100">Help us improve public services by reporting issues you've encountered.</p>
                    </div>
                    <a href="track-status.jsp"><button class="mt-4 md:mt-0 px-6 py-3 bg-white text-primary-blue font-bold rounded-lg hover:bg-blue-50 transition flex items-center">
            ...
            <div class="bg-white rounded-2xl shadow-lifted overflow-hidden mb-8">
                ...
                <form id="grievance-form" class="p-6">
                    <!-- Step 1: Basic Information -->
                    <div class="form-step active" id="step-1">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="department" class="block text-sm font-medium text-gray-700 mb-2">Department/Authority <span class="text-red-500">*</span></label>
                                <select id="department" name="department" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" required>
                                    <option value="">Select Department</option>
                                    <option value="dont-know">Don't Know</option>
                                    <option value="municipal-corporation">Municipal Corporation</option>
                                    <option value="electricity-department">Electricity Department</option>
                                    <option value="transport">Transport Department</option>
                                    <option value="water-department" disabled >Water Department <b>(coming soon)</b></option>
                                    <option value="public-works"disabled>Public Works Department <b>(coming soon)</b></option>                                    <option value="health"disabled>Health Department <b>(coming soon)</b></option>
                                    <option value="education"disabled>Education Department <b>(coming soon)</b></option>
                                    <option value="police"disabled>Police Department <b>(coming soon)</b></option>
                                </select>
                            </div>
                            
                            <div>
                                <label for="category" class="block text-sm font-medium text-gray-700 mb-2">Grievance Category <span class="text-red-500">*</span></label>
                                <select id="category" name="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" required>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="subject" name="subject" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" placeholder="Brief description of your grievance" required>
                            </div>
                        </div>
                        
                        <div class="flex justify-between mt-8">
                            <div></div> <!-- Empty div for spacing -->
                            <button type="button" class="next-step px-6 py-3 bg-primary-blue text-white font-medium rounded-lg hover:bg-blue-800 transition flex items-center">
                                Next Step
                    ...
                    <div class="form-step" id="step-2">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Detailed Description <span class="text-red-500">*</span></label>
                                <textarea id="description" name="description" rows="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" placeholder="Please provide a detailed description of the issue, including when it started, how it affects you, and any other relevant details." required></textarea>
                            </div>
                            
                            <div>
                                <label for="location" class="block text-sm font-medium text-gray-700 mb-2">Location <span class="text-red-500">*</span></label>
                                <input type="text" id="location" name="location" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" placeholder="Street, Area, Landmark" required>
                            </div>
                            
                            <div>
                                <label for="pincode" class="block text-sm font-medium text-gray-700 mb-2">Pincode <span class="text-red-500">*</span></label>
                                <input type="text" id="pincode" name="pincode" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue" placeholder="6-digit pincode" pattern="[0-9]{6}" required>
                            </div>
                            
                            <div>
                                <label for="date-observed" class="block text-sm font-medium text-gray-700 mb-2">Date First Observed</label>
                                <input type="date" id="date-observed" name="date-observed" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue">
                            </div>
                            
                            <div>
                                <label for="contact-preference" class="block text-sm font-medium text-gray-700 mb-2">Preferred Contact Method</label>
                                <select id="contact-preference" name="contact-preference" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue">
                                    <option value="email">Email</option>
                                </select>
                            </div>
                            
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Supporting Documents <span class="text-red-500">*</span></label>
                                <p class="text-xs text-gray-500 mb-4">At least one photo/document is required to submit your grievance</p>
                                
                                <!-- Camera Option -->
                                <div class="mb-4">
                                    <button type="button" id="camera-btn" class="px-4 py-2 bg-primary-blue text-white rounded-lg hover:bg-blue-800 transition flex items-center">
                                        <i class="fas fa-camera mr-2"></i>
                                        Use Camera
                                    </button>
                                    <video id="camera-preview" autoplay></video>
                                    <button type="button" id="capture-btn" class="px-4 py-2 bg-accent-green text-white rounded-lg hover:bg-green-700 transition flex items-center">
                                        <i class="fas fa-camera mr-2"></i>
                                        Capture Photo
                                    </button>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-primary-blue hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-blue">
                                                <span>Upload files</span>
                                                <input id="file-upload" name="file-upload" type="file" class="sr-only" multiple accept="image/*, .pdf" required>
                                            </label>
                                ...
                                <div id="attachment-error" class="text-red-500 text-sm mt-2 hidden">Please upload at least one supporting document</div>
                            </div>
                        </div>
                        
                        <div class="flex justify-between mt-8">
                            <button type="button" class="prev-step px-6 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition flex items-center">
                    ...
                    <div class="form-step" id="step-3">
                        <div class="bg-blue-50 p-4 rounded-lg mb-6">
                            <h3 class="font-medium text-primary-blue mb-2">Review Your Grievance</h3>
                            <p class="text-sm text-gray-600">Please review all the information below before submitting your grievance. You can go back to previous steps to make changes if needed.</p>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-gray-500">Date First Observed</h4>
                                    <p id="review-date" class="mt-1 text-gray-900">-</p>
                                </div>
                                <div>
                                    <h4 class="text-sm font-medium text-gray-500">Contact Preference</h4>
                            ...
                            <div class="border-t border-gray-200 pt-6">
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="consent" name="consent" type="checkbox" class="focus:ring-primary-blue h-4 w-4 text-primary-blue border-gray-300 rounded" required>
                                    </div>
                                    <div class="ml-3 text-sm">
                                        <label for="consent" class="font-medium text-gray-700">I confirm that the information provided is accurate to the best of my knowledge</label>
                                        <p class="text-gray-500">By submitting this grievance, I agree to the terms of service and privacy policy of the Setu Grievance Redressal Portal.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-8">
                            ...
                            <button type="submit" class="submit-grievance px-6 py-3 bg-accent-green text-white font-medium rounded-lg hover:bg-green-700 transition flex items-center">
            ...
            <div class="bg-white rounded-2xl shadow-lifted overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="font-heading text-xl font-bold text-primary-blue">Need Help?</h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <a href="how-to-submit.html"><div class="text-center">
                            ...
                            <p class="text-sm text-gray-500">Learn how to effectively submit a grievance with proper details.</p>
                        </div></a>
                        <a href="guidelines.html"><div class="text-center">
                            <div class="h-12 w-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                                <i class="fas fa-file-alt text-primary-blue text-xl"></i>
                            </div>
                            <h3 class="font-medium text-gray-900 mb-2">Grievance Guidelines</h3>
                            <p class="text-sm text-gray-500">Understand what types of grievances can be submitted.</p>
                        </div></a>
                        <a href=""><div class="text-center">
                            ...
                            <p class="text-sm text-gray-500">Get help from our support team if you face any issues.</p>
                        </div></a>
                    </div>
                </div>
            </div>
