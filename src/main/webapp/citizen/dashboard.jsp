...
<head>
    ...
    <title>Citizen Dashboard | Setu | Citizen Grievance Redressal Portal</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@600;700;800&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/dashbord.css">
...
<link rel="stylesheet" href="../style/lang.css">
                ...
                <div class="flex items-center space-x-4">
                    <a href="profile.jsp"><div class="hidden md:flex items-center space-x-2 bg-blue-50 px-4 py-2 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Civic Points: <%= citizen.getCivicPoints()%></p>
                        </div>
                    </div></a>
    ...
    <div class="flex">
        ...
        <div class="sidebar w-64 bg-white min-h-screen shadow-lg fixed md:relative z-40 md:z-auto">
            ...
            <nav class="mt-6">
                <a href="dashboard.jsp" class="flex items-center px-6 py-3 text-primary-blue bg-blue-50 border-r-4 border-primary-blue">
                    <i class="fas fa-home mr-3"></i>
                    <span>Dashboard</span>
                </a>
                <a href="submitTest.jsp" class="flex items-center px-6 py-3 text-gray-600 hover:bg-blue-50 hover:text-primary-blue transition">
        ...
        <div class="flex-1 p-6 md:p-8">
            ...
            <div class="bg-gradient-to-r from-primary-blue to-blue-700 rounded-2xl p-6 text-white mb-8 card-glow">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                        <h1 class="font-heading text-2xl md:text-3xl font-bold mb-2">Welcome , <%= name%></h1>
                        <p class="text-blue-100">Here's an overview of your grievance activity and account status.</p>
                    </div>
                    <a href="submit.jsp"><button class="mt-4 md:mt-0 px-6 py-3 bg-white text-primary-blue font-bold rounded-lg hover:bg-blue-50 transition flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="stats-card bg-white rounded-2xl p-6 shadow-lifted">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-gray-500 text-sm">Total Grievances</p>
                            <h3 class="font-heading text-2xl font-bold text-primary-blue mt-1">12</h3>
                        </div>
                ...
                <div class="stats-card bg-white rounded-2xl p-6 shadow-lifted">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="font-heading text-2xl font-bold text-accent-saffron mt-1">3</h3>
                        </div>
                        <div class="h-12 w-12 bg-orange-100 rounded-lg flex items-center justify-center">
                            <i class="fas fa-clock text-accent-saffron text-xl"></i>
                        </div>
                    </div>
                ...
                <div class="stats-card bg-white rounded-2xl p-6 shadow-lifted">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="font-heading text-2xl font-bold text-brand-gold mt-1">5</h3>
                        </div>
                        <div class="h-12 w-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                            <i class="fas fa-sync-alt text-brand-gold text-xl"></i>
                        </div>
                    </div>
                    <div class="mt-4 flex items-center text-sm">
                        <span class="text-gray-500">Being addressed</span>
                    </div>
                </div>
                ...
                <div class="stats-card bg-white rounded-2xl p-6 shadow-lifted">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="font-heading text-2xl font-bold text-accent-green mt-1">4</h3>
                        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-lifted overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                            <h2 class="font-heading text-xl font-bold text-primary-blue">Recent Grievances</h2>
                            <a href="track-status.jsp" class="text-sm text-primary-blue hover:underline">View All</a>
                        </div>
                        <div class="divide-y divide-gray-100">
                            <!-- Grievance Item 1 -->
                            <div class="grievance-item p-6">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h3 class="font-medium text-gray-900">Water Supply Issue in Sector 15</h3>
                                        <p class="text-sm text-gray-500 mt-1">Submitted on: 15 Oct 2025</p>
                                        <div class="flex items-center mt-2">
                                            <span class="px-2 py-1 bg-blue-100 text-primary-blue text-xs font-medium rounded">Water Department</span>
                                            
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm text-gray-500">Grievance ID</p>
                                        <p class="font-mono text-sm font-medium">SETU-2025-01542</p>
                                    </div>
                                </div>
                            ...
                            <div class="grievance-item p-6">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 mt-1">Submitted on: 10 Oct 2025</p>
                                        <div class="flex items-center mt-2">
                                            <span class="px-2 py-1 bg-blue-100 text-primary-blue text-xs font-medium rounded">Municipal Corporation</span>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm text-gray-500">Grievance ID</p>
                                        <p class="font-mono text-sm font-medium">SETU-2025-01489</p>
                                    </div>
                                </div>
                                <div class="mt-4 flex justify-between items-center">
                                </div>
                            ...
                            <div class="grievance-item p-6">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 mt-1">Submitted on: 5 Oct 2025</p>
                                        <div class="flex items-center mt-2">
                                            <span class="px-2 py-1 bg-blue-100 text-primary-blue text-xs font-medium rounded">Electricity Department</span>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm text-gray-500">Grievance ID</p>
                                        <p class="font-mono text-sm font-medium">SETU-2025-01376</p>
                                    </div>
                                </div>
                                <div class="mt-4 flex justify-between items-center">
                                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lifted overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            <a href="submit.jsp" class="mr-3"><button class="w-full flex items-center justify-between p-4 bg-blue-50 text-primary-blue rounded-lg hover:bg-blue-100 transition">
                            ...
                            <a href="track-status.jsp" class="mr-3"><button class="w-full flex items-center justify-between p-4 bg-blue-50 text-primary-blue rounded-lg hover:bg-blue-100 transition">
                                 <div class="flex items-center">
                            ...
                            <a href="profile.jsp" class="mr-3"><button class="w-full flex items-center justify-between p-4 bg-blue-50 text-primary-blue rounded-lg hover:bg-blue-100 transition">
                                <div class="flex items-center">
                                    <i class="fas fa-user mr-3"></i>
                                    <span>Profile & Settings</span>
                                </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lifted overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                            <h2 class="font-heading text-xl font-bold text-primary-blue">Notifications</h2>
                            <span class="bg-primary-blue text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">2</span>
                        </div>
                        <div class="divide-y divide-gray-100">
                            <div class="p-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium">Grievance Resolved</p>
                                        <p class="text-xs text-gray-500 mt-1">Your grievance SETU-2025-01489 has been resolved.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-4">
                                <div class="flex items-start">
                                    <div class="h-8 w-8 bg-yellow-100 rounded-full flex items-center justify-center mr-3">
                                        <i class="fas fa-award text-brand-gold text-xs"></i>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium">Civic Points Earned</p>
                                        <p class="text-xs text-gray-500 mt-1">You've earned 10 civic points for your active participation.</p>
...
<footer class="bg-primary-blue text-white">
   ...
   <script src="${pageContext.request.contextPath}/js/dashbord.js"></script>
</body>
</html>